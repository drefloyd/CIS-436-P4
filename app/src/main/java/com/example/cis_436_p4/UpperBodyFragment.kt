...
import com.example.cis_436_p4.databinding.FragmentUpperBodyBinding

class UpperBodyFragment : Fragment() {

    private lateinit var binding: FragmentUpperBodyBinding
    private lateinit var viewModel: UpperBodyViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(requireActivity())[UpperBodyViewModel::class.java]
        observeViewModel()
    }
    ...
    private fun setupViews() {
        val exercises = arrayOf("Planks", "Pushups", "Dips")
    ...
    private fun setupListeners() {
        ...
        binding.btnLowerHome.setOnClickListener {
            findNavController().navigate(R.id.action_upperBodyFragment_to_homeFragment)
        }
    }
